...
import (
	...
	"github.com/guibonf1m/apiprodutos/nomedoseumodulo/entity" // Importa a definição da struct Produto
...
var id int = 4                     // Inicializa um ID fictício para usos de exemplo
...
func GetProduto(c *gin.Context) { // Handler para listar todos os produtos
